...
public class PersistenceManager {
    private static final String url = "jdbc:mysql://localhost:8889/catering?serverTimezone=UTC";
    ...
    public static int executeUpdate(String update) {
        ...
        try (Connection conn = DriverManager.getConnection(url, username, password);
            ...
            if(ex instanceof SQLIntegrityConstraintViolationException) {
                System.out.println("Errore: ID o nome duplicato! Errore di Logica del Caso d'Uso\n");
            } else {
                ex.printStackTrace();
            }
        }
